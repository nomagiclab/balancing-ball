...
class PidPerformer:
    def __init__(self, pybullet_client, ball: ABCBall, paddle: ABCPaddle):
        self.pybullet_client = pybullet_client
        self.pid_sliders, self.pid_button, self.pid_balancer = init_standard_pid_tools(pybullet_client, ball, paddle,
                                                                                       45, -45)
        self.paddle = paddle
